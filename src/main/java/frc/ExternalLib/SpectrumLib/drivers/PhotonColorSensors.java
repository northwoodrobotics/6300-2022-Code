package frc.ExternalLib.SpectrumLib.drivers;
...
public class PhotonColorSensors implements AutoCloseable {
  ...
  public PhotonColorSensors() {
    readThread = new Thread(this::threadMain);
    readThread.setName("PhotonColorSensorThread");
    readThread.start();
  }
