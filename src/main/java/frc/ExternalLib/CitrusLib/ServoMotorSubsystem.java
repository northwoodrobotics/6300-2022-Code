...
public abstract class ServoMotorSubsystem extends Subsystem {
        ...
        mEnabledLooper.register(new Loop() {
            ...
            public void onLoop(double timestamp) {
                ...
                if (mPeriodicIO.reset_occured) {
                    ...
                    if (mConstants.kRecoverPositionOnReset) {
                        mMaster.setSelectedSensorPosition(estimateSensorPositionFromAbsolute(), 0, CitrusConstants.kCANTimeoutMs);
                    }
                }
    ...
    public synchronized void setGoalMotionProfiling(MotionProfileGoal goal, double feedforward_v) {
        ...
        Setpoint setpoint = mSetpointGenerator.getSetpoint(mMotionProfileConstraints, goal, cur_state, mPeriodicIO.timestamp + CitrusConstants.kLooperDt);
