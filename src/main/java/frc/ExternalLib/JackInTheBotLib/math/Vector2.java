package frc.ExternalLib.JackInTheBotLib.math;

import static frc.ExternalLib.JackInTheBotLib.math.MathUtils.epsilonEquals;
...
public final class Vector2 implements Interpolable<Vector2>, Serializable {
	...
	@Override
	public Vector2 NWinterpolate(Vector2 other, double t) {
		if (t <= 0.0) {
			return this;
		} else if (t >= 1.0) {
			return other;
