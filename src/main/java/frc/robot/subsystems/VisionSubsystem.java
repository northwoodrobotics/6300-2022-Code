...
public class VisionSubsystem implements Subsystem {
    ...
    public VisionSubsystem(SwerveSubsystem drivetrainSubsystem) {
        ...
        tab.addNumber("Horizontal Target Error", () -> {
                    double gyroAngle = RobotContainer.m_swerveSubsystem.dt.getGyroscopeRotation().getRadians();
    ...
    public void periodic() {
        ...
        if (hasTarget) {
            ...
            double angleToOuter = RobotContainer.m_swerveSubsystem.dt.getCurActPose().getRotation().getRadians() - targetPosition.getX();
