...
public class TwoBallRed extends SequentialCommandGroup{
    public TwoBallRed(SwerveSubsystem subsystem, ShooterSubsystem shooter, Vision blindlight, FeederSubsystem feeder, IntakeSubsystem intake){
        addCommands(
            new AutoDrive(subsystem, PathHolder.TwoBallRed), 
            //new ShooterCommand(shooter, blindlight).alongWith(new PurgeFeeder(feeder, 0.3)),
            new DriveAndIntake(PathHolder.TwoBallRed2, subsystem, intake, feeder),
