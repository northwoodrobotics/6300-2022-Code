...
public class SortBall extends SequentialCommandGroup{
    ...
    public SortBall(FeederSubsystem feeder){
        addCommands(
            new WaitForBall(feeder), new RunFeeder(feeder), new WaitForBall(feeder),new RunFeeder(feeder),new WaitForBall(feeder), new RunFeeder(feeder), new WaitForBall(feeder),new RunFeeder(feeder),new WaitForBall(feeder), new RunFeeder(feeder), new WaitForBall(feeder),new RunFeeder(feeder)
        );
