...
public final class Constants {
     ...
     */
        ...
        public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0); // FIXME Measure and set front right steer offse
        ...
        public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(3.6); // FIXME Measure and set back left steer offset
        ...
        public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(180); // FIXME Measure and set back right steer offset        
    ...
    public final static class ShooterConstants{
        ...
        static {
          ...
          //  HoodPositionTable.put(new InterpolatingDouble(1.3), new InterpolatingDouble(15.0));
            ...
            HoodPositionTable.put(new InterpolatingDouble(3.5), new InterpolatingDouble(40.0));
            HoodPositionTable.put(new InterpolatingDouble(4.0), new InterpolatingDouble(41.5));            
        }
    }
}
